...
SWIFT_MODULE_NAMESPACE_PUSH("GPChat")


@class NSCoder;

SWIFT_CLASS("_TtC6GPChat18RootViewController")
...
SWIFT_CLASS("_TtC6GPChat25MessageListViewController")
@interface MessageListViewController : RootViewController <UITableViewDataSource, UITableViewDelegate>
...
- (void)chatChange;
- (void)socketStatusChangeWithNoti:(NSNotification * _Nonnull)noti;
...
SWIFT_CLASS("_TtC6GPChat21MessageViewController")
@interface MessageViewController : RootViewController <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UIImagePickerControllerDelegate, UINavigationControllerDelegate>
@property (nonatomic, readonly) UIStatusBarStyle preferredStatusBarStyle;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC6GPChat13SocketManager")
...
- (BOOL)webSocketShouldConvertTextFrameToString:(SRWebSocket * _Null_unspecified)webSocket SWIFT_WARN_UNUSED_RESULT;
@end

@class UIEvent;

@interface UIButton (SWIFT_EXTENSION(GPChat))
...
SWIFT_CLASS("_TtC6GPChat10UploadTool")
