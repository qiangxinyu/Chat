...
var getQNToken = () => {
    ...
    var bucketName = 'testimage'
    var accessKey = 'CejIDllxxkKRj_Xf547-dq-QGvYW_xw1PhwTjAEN'
    var secretKey = 'BwOTDW_OFSN7P7yilFoRMtC-slnlfB6h6aNK-lmx'
    policy.scope = bucketName;

    var deadline = Math.round(new Date().getTime() / 1000) + 12 * 3600
    policy.deadline = deadline;

    return genUpToken(accessKey, secretKey, policy)
}



module.exports = getQNToken
